...
void main() {
  ...
  group('CustomButton', () {
    testWidgets('renders correctly with given text', (WidgetTester tester) async {
      // ARRANGE
    ...
    testWidgets('renders as elevated button when isOutlined is false', (WidgetTester tester) async {
      // ARRANGE
      await tester.pumpWidget(makeTestableWidget(
        CustomButton(
          text: 'Test Button',
    ...
    testWidgets('uses theme color when no custom color is provided', (WidgetTester tester) async {
      // ARRANGE
      await tester.pumpWidget(makeTestableWidget(
        CustomButton(
          text: 'Test Button',
