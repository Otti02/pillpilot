...
void main() {
  ...
  group('AppointmentItem', () {
    ...
    testWidgets('renders appointment details correctly', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        makeTestableWidget(AppointmentItem(appointment: testAppointment)),
      );
    ...
    testWidgets('renders appointment without notes', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        makeTestableWidget(
