...
void main() {
  ...
  group('CustomCalendar', () {
    testWidgets('renders CalendarDatePicker', (WidgetTester tester) async {
      await tester.pumpWidget(makeTestableWidget(CustomCalendar()));
      expect(find.byType(CalendarDatePicker), findsOneWidget);
    });

    testWidgets('calls onDateSelected when a date is selected', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('uses initialDate if provided', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        makeTestableWidget(CustomCalendar(initialDate: initialDate)),
      );
    ...
    testWidgets('does not fail if onDateSelected is null', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(makeTestableWidget(CustomCalendar()));
      final state = tester.state(find.byType(CustomCalendar)) as dynamic;
